...
|`-git [path HHTPS GitHub / GitLab]`|Permette di specificare il path HTTPS di GitHub / GitLabda cui scaricare il source code. Opzionale, non utilizzare se è già presente il source code|
